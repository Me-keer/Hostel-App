...
const  History_requests=()=>{
  ...
  return (
    <View style={{justifyContent:'center',alignItems:'center'}}>
        <Text style={{fontSize:30,alignItems:'center'}}>Request History</Text>
        <FlatList
          data={users}
          numColumns={1}
          renderItem={({item})=>(
      ...
      <View style={styles.content}>
        ...
        <View style={styles.priceContainer}>
          <Text style={styles.priceLabel}>Request</Text>
          <Text style={styles.price}>{item.Request}</Text>
        </View>
      </View>
    </View>
          )}
...
export default History_requests;
